"""
Simplified SOS PowerPoint Engine
Connects to nowPlaying socket and controls PowerPoint slides based on clip names.
"""
...
class SimplePPEngine:
    """Simplified PowerPoint engine for SOS integration."""
    ...
    def __init__(self, pp, pp_dictionary):
        ...
        Args:
            pp: PowerPoint controller object
    ...
    def run(self, poll_interval=2):
        ...
        """
        print("Starting PowerPoint Engine...")
