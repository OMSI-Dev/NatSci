...
def check_directory_modified(host: str = "10.10.51.87", 
                             ...
                             days: int = 3):
    """
    v1 note: I forgot to check for CCs in this version.
...
def parse_playlist_file(file_content: str):
    """
    ...
    Returns:
        dict: Dictionary with parsed fields (name, category, majorcategory, data, is_movie)
...
def download_and_parse_playlist(remote_path: str,
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            return parse_playlist_file(content)
        else:
...
def generate_server_index(output_file: str = "noaa_server_index.csv",
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ['name', 'category', 'majorcategory', 'is_movie', 'pretty_name', 'path']
