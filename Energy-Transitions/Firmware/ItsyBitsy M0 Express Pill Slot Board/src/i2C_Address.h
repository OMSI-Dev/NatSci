...
void printI2Caddress()
{
   ...
   {
   case 0x08:
      Serial.println("Buoy (none) - accepts Buoy + Wind");
      break;
   case 0x09:
      Serial.println("Dam (A) - accepts Dam + Wind + Solar");
      break;
   case 0x0A:
      Serial.println("Geo (B) - accepts Geo + Wind + Solar");
      break;
   case 0x0B:
      Serial.println("Solar (C) - accepts Solar + Wind");
      break;
   case 0x0C:
      Serial.println("Buoy (D) - accepts Buoy + Wind");
      break;
   case 0x0D:
      Serial.println("Dam (AB) - accepts Dam + Wind + Solar");
      break;
   case 0x0E:
      Serial.println("Geo (AC) - accepts Geo + Wind + Solar");
      break;
   case 0x0F:
      Serial.println("Solar (AD) - accepts Solar + Wind");
      break;
   case 0x10:
      Serial.println("Dam (BC) - accepts Dam + Wind + Solar");
      break;
   case 0x11:
      Serial.println("Geo (BD) - accepts Geo + Wind + Solar");
      break;
   default:
