...
async def PJ1Power():
        try:
            print("______________________________________")
            print("Attempting to turn off PJ1.")
            await asyncio.wait_for(PJ1.power.turn_off(),timeout = 1.5)
...
async def PJ2Power():
        try:
            print("______________________________________")
            print("Attempting to turn off PJ2.")
            await asyncio.wait_for(PJ2.power.turn_off(),timeout = 1.5)
            await asyncio.sleep(5)
...
async def PJ3Power():
        try:
            print("______________________________________")
            print("Attempting to turn off PJ3.")
            await asyncio.wait_for(PJ3.power.turn_off(),timeout = 1.5)
            await asyncio.sleep(5)
...
async def PJ4Power():
        try:
            print("______________________________________")
            print("Attempting to turn off PJ4.")
            await asyncio.wait_for(PJ4.power.turn_off(),timeout = 1.5)
            await asyncio.sleep(5)
