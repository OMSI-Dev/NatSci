...
* like any object.
*
* Keeping Carbon Stored - TILE INFO
* Nat Sci Hall - OMSI
* Calico Rose
* This script keeps track of which tile names belong to which round, and which tiles have been
* pressed or not.
*/
...
public partial class TileInfo : Node
{
	...
	{
		// All tiles have initially not been hit.
		foreach (var t in round1Tiles) { round1States.Add(false); }
		foreach (var t in round2Tiles) { round2States.Add(false); }
	}
